...
#' \describe{
#' \item{tf}{TF involved in the interaction}
#' \item{mirna}{miRNA involved in the interaction (miRNA targeted by TF)}
...
#' \describe{
#' \item{tf}{TF involved in the interaction}
#' \item{targetgene}{target gene involved in the interaction (gene targeted by TF)}
